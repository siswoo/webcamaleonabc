		...
		<ol class="carousel-indicators">
	  	...
	  	<div class="carousel-inner">
	    	<div class="carousel-item active">
	      		<img class="d-block w-100 h-100" src="img/sliders/slider4.webp" alt="Segundo slider" style="max-height: 600px;">
	    	</div>
...
<div class="seccion5" style="background-color: black; padding-top: 2rem; padding-bottom: 2rem;">
	<div class="container">
		<div class="row">
			<div class="col-12 col-sm-12 col-md-12 col-lg-6 col-xl-6 text-justify">
				<div class="col-12 seccion5_titulo1 text-center">MISIÓN</div>
			...
			<div class="col-12 col-sm-12 col-md-12 col-lg-6 col-xl-6 text-justify">
				<div class="col-12 seccion5_titulo1 text-center">VISIÓN</div>
...
<script>
	...
	function estructura1(value){
	    ...
	    if(value=='VIP'){
	      ...
	      var sede = 'CAV';
	      var imagen = 'img/eo_cav.webp';
	    }else if(value=='Suba'){
	      var sede = 'Suba';
	      var imagen = 'img/eo_suba.webp';
	    }else if(value=='Norte'){
	      var sede = 'Norte';
	      var imagen = 'img/img8.webp';
