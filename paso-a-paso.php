...
?>
	...
	<div id="seccion4_sub1_1" style="display: none;">
		<div class="row">
			<div class="col-12 col-sm-12 col-md-12 col-lg-12 col-xl-12 mt-12 text-center">
				<p style="font-size: 30px; font-weight: bold; margin-bottom: 2rem; color: white; margin-top: 2rem; text-transform: uppercase; margin-left: 4rem; margin-right: 4rem;">
		...
		<div class="modal-dialog modal-dialog-centered modal-lg">
			<div class="modal-content">
				<div class="modal-header">
					<h4 class="modal-title" style="font-weight: bold;">USO DEL PASO A PASO</h4>
					<button type="button" class="close" data-dismiss="modal" aria-hidden="true">&times;</button>
				</div>
				<div class="modal-body">
					<img src="img/mark1/instructivo-guia.png" class="img-fluid">
				</div>
				<!--
