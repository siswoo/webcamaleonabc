            ...
            <div class="col-12">
              ...
              <tbody id="resultados">
                ...
                while($row2 = mysqli_fetch_array($resultado2)) {
                  ...
                  $inventario_sede = '';
                  $inventario_cantidad = '';
                  $sql5 = "SELECT * FROM t_inventario WHERE id_producto = ".$producto_id;
                  $resultado5 = mysqli_query($conexion,$sql5);
                  while($row5 = mysqli_fetch_array($resultado5)) {
                    $inventario_cantidad = $row5['cantidad'];
                    $inventario_sede = $row5['sede'];

                    $inventario_colores = $row5['colores'];
                    $inventario_tamanios = $row5['tamanios'];
                    $inventario_sabores = $row5['sabores'];
                    ...
                    if($inventario_sede==''){
                      $sede_nombre = 'Sin Asignar';
                    }else{
                      $sql7 = "SELECT * FROM t_sedes WHERE id = ".$inventario_sede;
                      $resultado7 = mysqli_query($conexion,$sql7);
                      while($row7 = mysqli_fetch_array($resultado7)) {
                        $sede_nombre = $row7['nombre'];
                      }
                    }

                    echo '
                      <tr id="tr_productos_'.$producto_id.'">
                            <td class="text-center">'.$producto_id.'</td>
                            ...
                            <td class="text-center">'.$inventario_tamanios.'</td>
                            <td class="text-center">'.$inventario_sabores.'</td>
                            <td class="text-center">'.$inventario_colores.'</td>
          ...
          <div class="row">
            ...
            <div id="add_div1" class="col-12 form-group form-check" style="display: none;">
              ...
              <div class="col-12 mt-3 mb-3" id="add_div_color1" style="display: none;">
                ...
                <div class="col-12">
                  <label for="add_color_file1">Imagen</label>
                  <input type="file" id="add_color_file1" name="add_color_file1" class="form-control">
                </div>
              </div>
...
<script type="text/javascript">
  ...
  $("#formulario_consultar_registro1").on("submit", function(e){
    ...
    if(agregar=='Color'){
      var fd = new FormData();
      var files = $('#add_color_file1')[0].files[0];
    ...
    if(agregar=='Tamaño'){
      var alto = $('#add_tamaño_alto1').val();
      var ancho = $('#add_tamaño_ancho1').val();
      $.ajax({
        url: '../script/crud_productos1.php',
        type: 'POST',
        data: {
    ...
    if(agregar=='Sabor'){
      var nombre1 = $('#add_sabor_nombre1').val();
      $.ajax({
        url: '../script/crud_productos1.php',
        type: 'POST',
        data: {
